   ...
   <div class="row align-items-center">
      <div class="col-auto">
         <ol class="breadcrumb" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0)">Tất cả</a></li>
         </ol>
      </div>
   </div>
</div>
   ...
   <div class="col-md-12">
      <div class="card">
         <div class="card-header" style="    justify-content: space-between;">
            <h3 class="card-title">Tất cả các liên kết</h3>
            <div class="">
               <a href="#" class="btn btn-danger mr-2 delete-selecetd-items d-none">Xóa các liên kết đã chọn &nbsp;(<b>0</b>) </a>
               <a href="<?=PROOT?>/links/new" class="btn btn-primary">Thêm liên kết</a>
            </div>
         </div>
                  ...
                  <tr id="link-<?=$id?>" data-id="<?=$id?>">
                     ...
                     <td>
                        <div class="btn-list flex-nowrap">
                           ...
                           <a href="javascript:void(0)" class="text-danger ml-2 del-link" data-toggle="tooltip" data-id="<?=$id?>" data-placement="top" title="xóa bỏ">

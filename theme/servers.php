   ...
   <div class="row align-items-center">
      <div class="col-auto">
         <ol class="breadcrumb" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0)">Máy chủ</a></li>
         </ol>
      </div>
   </div>
</div>
...
<div class="row">
                  ...
                  <tbody>
                     ...
                     <tr data-id="<?=$server['id']?>">
                        ...
                        <td class="text-muted">
                           ...
                           <span class="badge bg-green-lt">Đã kết nối</span>
                           <?php else: ?>
                           <span class="badge bg-red-lt">Thất bại</span>
                           <?php endif; ?>
                        </td>
                        <td>
                           <div class="btn-list flex-nowrap">
                              <?php if($server['status'] == 0): ?>
                              <a href="<?=PROOT?>/servers/status/<?=$server['id']?>" class="text-success ml-2"  data-toggle="tooltip" data-placement="top" title="Tạm ngừng">
                              ...
                              <?php else: ?>
                              <a href="<?=PROOT?>/servers/status/<?=$server['id']?>" class="text-danger ml-2"  data-toggle="tooltip" data-placement="top" title="Hoạt động">
                              ...
                              <?php endif; ?>
                              <a href="#" class="text-secondary ml-2 edit-server"  data-toggle="tooltip" data-placement="top" title="Chỉnh sửa">
                              ...
                              <a href="javascript:void(0)" class="text-info ml-2 refresh-server"  data-toggle="tooltip" data-placement="top" title="Làm mới">
                              ...
                              <a href="javascript:void(0)" class="text-danger del-server ml-2" data-url="<?=PROOT?>/servers/del/<?=$server['id']?>"   data-toggle="tooltip" data-placement="top" title="Xóa bỏ">
                                 <svg class="icon " width="1em"  style="font-size:1.3rem" height="1em" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   ...
   <div class="col-md-4">
      <div class="card">
         <div class="card-header">
            <h3 class="card-title">Thêm / Chỉnh sửa máy chủ</h3>
         </div>
         <div class="card-body">
            <?=$this->displayAlerts()?>

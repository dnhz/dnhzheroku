   ...
   <div class="row align-items-center">
      <div class="col-auto">
         <ol class="breadcrumb" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0)">Chỉnh sửa liên kết</a></li>
         </ol>
      </div>
   </div>
</div>
      ...
      <div class="col-md-8">
         <div class="card">
            <div class="card-header">
               <h3 class="card-title">Chỉnh sửa liên kết</h3>
            </div>
            <div class="card-body">
               ...
               <div class="form-group mb-3 ">
                  ...
                  <div>
                     <input type="text" class="form-control" name="title" value="<?=$link['title']?>"  placeholder="Nhập tên tệp">
                  </div>
               </div>
               <div class="form-group mb-3 ">
                  ...
                  <div>
                     <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" name="main_link" value="<?=$link['main_link']?>" placeholder="Nhập liên kết chính của bạn" required>
                     </div>
               ...
               <div class="form-group mb-3 ">
                  ...
                  <input type="text" class="form-control" name="alt_link" value="<?=$link['alt_link']?>" placeholder="Nhập liên kết thay thế của bạn">
                  <small class="form-hint">Các nguồn được hỗ trợ: google drive, google photos, one drive, yadisk, direct </small>
               </div>
               <div class="form-group mb-3 ">
                  ...
                  <div class="" id="sub-list">
                     ...
                     <div class="row row-sm mb-2" id="<?=$k==0?'add-sub-dumy':''?>">
                        ...
                        <div class="col">
                           <input type="file" name="sub[<?=$k+1?>][file]"  placeholder="Tìm kiếm…">
               ...
               <div class="form-group mb-3 ">
                  ...
                  <div>
                     ...
                     <div class="preview-img-wrap mt-2">
                        ...
                        <a href="javascript:void(0)" class="text-danger remove-preview-img">Tẩy</a>
                     </div>
                     <?php endif; ?>
                  </div>
               </div>
               <div class="form-group mb-3 ">
                  <label class="form-label">Tùy chỉnh slug</label>
                  <div>
                     <input type="text" class="form-control" name="slug" value="<?=$link['slug']?>" placeholder="Nhập slug video tùy chỉnh" required>
                  </div>
               </div>
               <div class="form-group mb-3 ">
                  <label class="form-label">Trạng thái liên kết</label>
                  <select class="form-select" name="status">
                     <option value="active" <?=$link['status'] == 0 ? 'selected' : ''?> >Hoạt động</option>
                     <option value="inactive" <?=$link['status'] == 1 ? 'selected' : ''?> >Bản nháp</option>
                  </select>
               </div>
               <div class="mb-3">
                  <ul>
                     <li> <b>Được tạo lúc</b> : <i><?=Helper::formatDT($link['created_at'])?></i> </li>
                     <li> <b>Cập nhật lần cuối lúc</b> : <i><?=Helper::formatDT($link['updated_at'])?></i> </li>
                  </ul>
               </div>
...
<div class="row">
   <div class="col-md-4">
      <div class="card">
         <div class="card-header">
            <h3 class="card-title">Liên kết phát trực tiếp</h3>
         </div>
         <div class="card-body">
            ...
            <div class="position-relative">
               ...
               <button type="button" class="btn btn-sm btn-success position-absolute" id="copyStreamLink" style="bottom: 8px;right:8px;">sao chép</button>
            </div>
            <small>Phẩm chất có sẵn: <?=implode(', ',Helper::getQulities($link['data']))?></small>
            <?php else: ?>
            <small>Không có sẵn !</small>
            <?php endif; ?>
         </div>
      </div>
   </div>
   <div class="col-md-4">
      <div class="card">
         <div class="card-header">
            <h3 class="card-title">Liên kết phát</h3>
         </div>
         <div class="card-body">
            <div class="position-relative">
   ...
   <div class="col-md-4">
      <div class="card">
         <div class="card-header">
            <h3 class="card-title">Mã nhúng</h3>
         </div>
         <div class="card-body">
            <div class="position-relative">
               ...
               <button type="button" class="btn btn-sm btn-success position-absolute" id="copyEmbedCode" style="bottom: 8px;right:8px;">sao chép</button>
            </div>
         </div>
      </div>
   </div>

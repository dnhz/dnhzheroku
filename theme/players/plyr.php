      ...
      <div class="__000ab d-none" id="__000ab">
         <div class="__000ab-content">
            <div class="top">
               ...
               <h2 class="my-3">Phát hiện Adblock</h2>
               <p class="mb-3 "><b>Chúng tôi đã phát hiện ra rằng bạn đang sử dụng làm plugin trình duyệt adblock <br> để tắt quảng cáo tải trên trang web của chúng tôi.</b> </p>
            </div>
            <div class="bottom">
               <p class="mb-3">
                  Doanh thu kiếm được từ quảng cáo cho phép chúng tôi cung cấp nội dung chất lượng <br>
                  bạn đang cố gắng truy cập trên trang web này.  Để xem trang này, chúng tôi yêu cầu <br>
                  rằng bạn tắt adblock trong cài đặt plugin
               </p>
               <a href="<?=$_SERVER['REQUEST_URI']?>" class="btn btn-block btn-danger">Tôi đã vô hiệu hóa Adblock cho trang web này</a>
            </div>
         </div>
      </div>
      <?php endif; ?>

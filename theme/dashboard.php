      ...
      <div class="col-auto">
         <ol class="breadcrumb" aria-label="breadcrumbs">
            <li class="breadcrumb-item">
               <a href="<?=PROOT?>/dashboard">Bảng điều khiển
               </a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">
               <a href="javascript:void(0)">Tổng quát
               </a>
            </li>
         </ol>
      </div>
   ...
   <div class="col-sm-6 col-lg-3">
      <div class="card">
         <div class="card-body py-4 px-2 text-center">
            ...
            <div class="text-muted ">Tổng số liên kết
            </div>
         </div>
      </div>
   </div>
   <div class="col-sm-6 col-lg-3">
      <div class="card">
         <div class="card-body py-4 px-2 text-center">
            ...
            <div class="text-muted ">Tổng số lượt xem
            </div>
         </div>
      </div>
   </div>
   <div class="col-sm-6 col-lg-3">
      <div class="card">
         <div class="card-body py-4 px-2 text-center">
            ...
            <div class="text-muted ">Tổng số máy chủ
            </div>
         </div>
      </div>
   </div>
   <div class="col-sm-6 col-lg-3">
      <div class="card">
         <div class="card-body py-4 px-2 text-center">
            ...
            <div class="text-muted ">Liên kết bị hỏng
            </div>
         </div>
      </div>
   </div>
...
<div class="row ">
   <div class="col-md-6 col-lg-8">
      <div class="card">
         <div class="card-header">
            <h4 class="card-title">Liên kết đang hoạt động
            </h4>
         </div>
                  ...
                  <tr>
                     ...
                     <td>
                        <div class="btn-list flex-nowrap     " style="justify-content: center;">
                           <a href="javascript:void(0)" class="text-dark copy-plyr-link" data-url="<?=Helper::getPlyrLink($this->config['playerSlug'], $link['slug'])?>" data-toggle="tooltip" data-placement="top" title="sao chép liên kết trình phát">
                           ...
                           <a href="javascript:void(0)" class="text-secondary ml-2 copy-embed-code" data-url="<?=Helper::getPlyrLink($this->config['playerSlug'], $link['slug'])?>" data-toggle="tooltip" data-placement="top" title="sao chép mã nhúng">
                           ...
                           <a href="<?=PROOT?>/links/edit/<?=$link['id']?>" class="text-info ml-2" data-toggle="tooltip" data-placement="top" title="chỉnh sửa">
      ...
      <div class="card">
         <div class="card-header">
            <h4 class="card-title">Liên kết gần đây
            </h4>
         </div>
         <div class="table-responsive">
            <table class="table card-table table-vcenter">
   ...
   <div class="col-md-6 col-lg-4">
      <div class="card">
         <div class="card-body">
            <h3 class="card-title">Trạng thái liên kết
            </h3>
            <div id="links-status" >
            </div>
         </div>
      ...
      <div class="card">
         <div class="card-body">
            <h3 class="card-title">Sử dụng máy chủ
            </h3>
      ...
      <div class="card">
         <div class="card-body">
            <div style="
               ...
               <a href="<?=PROOT?>/settings/proxy">Đi tới cài đặt proxy
               </a>
            </div>
            <div class="row">
               <div class="text-center col-6">
                  ...
                  <div class="text-muted mb-2">Proxy hoạt động
                  </div>
               </div>
               <div class="text-center col-6">
                  <div class="h1 m-0 text-danger" >
                  ...
                  <div class="text-muted mb-2">Proxy bị hỏng
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="card">
         <div class="card-body">
            <div style="
               ...
               <a href="<?=PROOT?>/settings/gauth">Đi tới cài đặt gauths
               </a>
            </div>
            <div class="row">
               <div class="text-center col-6">
                  ...
                  <div class="text-muted mb-2">Gauth hoạt động
                  </div>
               </div>
               <div class="text-center col-6">
                  <div class="h1 m-0 text-danger" >
                  ...
                  <div class="text-muted mb-2">Gauth bị hỏng
                  </div>
               </div>
            </div>
         </div>

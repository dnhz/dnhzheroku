...
<html lang="vi">
   <head>
      ...
      <title>Đăng Nhập Quản Trị Viên - GDplyr</title>
         ...
         <div class="container-tight py-6">
            ...
            <form class="card card-md" action="<?=$_SERVER['REQUEST_URI']?>" method="post">
               <div class="card-header bg-primary text-light">
                  <h3 class="mb-0 d-block text-center w-100">Đăng Nhập Quản Trị Viên</h3>
               </div>
               <div class="card-body">
                  ...
                  <div class="mb-3"> 
                     <input type="text" class="form-control" name="username" placeholder="Điền tên đăng nhập" autocomplete="off" required>
                  </div>
                  <div class="mb-2">
                     <div class="input-group input-group-flat">
                        <input type="password" class="form-control" name="password"  placeholder="Nhập mật khẩu" required>
                        <span class="input-group-text">
                           <a href="#" class="link-secondary" title="Hiển thị mật khẩu" data-toggle="tooltip">
            ...
            <div class="text-center text-muted">
               Phát triển bởi  <a href="https://www.codester.com/codyseller" tabindex="-1">CodySeller</a> &nbsp;|&nbsp;&copy;2021
            </div>
         </div>
      </div>
      <script>

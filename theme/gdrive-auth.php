   ...
   <div class="col-md-8">
      <div class="card">
         <div class="card-header" style="justify-content: space-between;">
            ...
            <div class="">
               <a href="<?=PROOT?>/settings/gauth/new" class="btn btn-primary">Thêm tài khoản</a>
            </div>
         </div>
         <div class="card-body">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <span class="badge bg-green-lt sd-<?=$auth['id']?>">Hoạt động</span>
                           <?php else: ?>
                           <span class="badge bg-red-lt sd-<?=$auth['id']?>">Hoạt động</span>
                           <?php endif; ?>
                        </td>
                        <td><?=Helper::formatDT($auth['updated_at'])?></td>
                        <td>
                           <div class="btn-list flex-nowrap">
                              <a href="<?=PROOT?>/settings/gauth/edit/<?=$auth['id']?>" class="text-secondary ml-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Chỉnh sửa">
                              ...
                              <a href="javascript:void(0)" class="text-info ml-2 refresh-gauth"  data-toggle="tooltip" data-placement="top" title="" data-id="<?=$auth['id']?>" data-original-title="Làm mới">
                              ...
                              <a href="javascript:void(0)" class="text-danger del-gauth ml-2" data-url="<?=PROOT?>/settings/gauth/del/<?=$auth['id']?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Xóa bỏ">
                                 <svg class="icon " width="1em" style="font-size:1.3rem" height="1em" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

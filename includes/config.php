...
*/
define('DB_HOST', '103.97.125.252'); // Your mySQL Host (usually Localhost)
define('DB_USER', 'ngochung_play'); // Your mySQL Databse username
define('DB_PASS', 'play@123123'); // Your mySQL Databse Password
define('DB_NAME', 'ngochung_play'); // The database where you have dumped the included sql file
